...
import 'package:gearcare/localStorage/localstorageservice.dart';
...
class _AddproductState extends State<Addproduct> {
  ...
  Future<void> _saveProduct() async {
    ...
    try {
      ...
      final String savedImagePath = await _storageService.saveImage(_image!);

      // Create product object with the saved image path
